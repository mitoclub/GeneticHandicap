...
pdf("../../body/4figures/01A.SlimOutParser.MSE.R.pdf", height = 14, width = 14)
#par(mfrow = c(2,1))
library(data.table)
...
hist(Genome$SdvNumber, breaks = 100, xlab = 'number of SDV per genome', main = title, cex.main=0.75, xlim = c(0,15), ylim = c(0,30000)) # can we compare it with Poisson distribution? 
